...
namespace RESTAPI.Data
{
    public class UsersTeachersAPITestDbContext : DbContext
    {
        ...
        public UsersTeachersAPITestDbContext(DbContextOptions<UsersTeachersAPITestDbContext> options) : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.Firstname).HasMaxLength(50).HasColumnName("FIRTNAME");
                entity.Property(e => e.Lastname).HasMaxLength(50).HasColumnName("LASTNAME");
                entity.Property(e => e.UserRole).HasColumnName("USER_ROLE").HasConversion<string>().HasMaxLength(50).IsRequired();
            });
        }
    }
}
